...
export default async function DynamicHome() {
  const data = await fetch('https://aey7vvraaf.execute-api.us-east-1.amazonaws.com/dev/v2/schools/teresiano/activities?registered_student=true', { cache: 'force-cache' })
